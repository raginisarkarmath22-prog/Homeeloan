...
/>
        ...
        <ul className="hidden xl:flex space-x-4 font-serif items-center justify-center col-span-1 ml-16">
          ...
          <li className="cursor-pointer text-black hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-blue-800 hover:to-green-800 transition-all duration-300">Compare Loan</li>
        </ul>
